...
ASSEMBLED_OUTPUT="${1:-$ROOT_DIR/doc/BWSSYSTEM.md}"
...
require_contains "$PARTS_DIR/_index.md" "Primary output: \`doc/BWSSYSTEM.md\`" "index primary output"
...
require_contains "$ASSEMBLED_OUTPUT" "Primary output: \`doc/BWSSYSTEM.md\`" "assembled primary output"
